...
var fs = require("fs");
var gerador_base_1 = require("../gerador.base");
var relacionamento_model_1 = require("../../model/relacionamento.model");
var tabela_service_1 = require("../../service/tabela.service");
var java_model_1 = require("../java/java.model");
var java_controller_1 = require("./java.controller");
var java_service_1 = require("./java.service");
var java_repository_1 = require("./java.repository");
var GeradorJava = /** @class */ (function (_super) {
    __extends(GeradorJava, _super);
    function GeradorJava() {
        var _this = _super.call(this) || this;
        _this.caminhoFontes = 'I:/Doc/node/gerador.codigo/fontes/java/';
        _this.arquivoTemplateModel = 'I:/Doc/node/gerador.codigo/template/java/Java.Model.mustache';
        _this.arquivoTemplateController = 'I:/Doc/node/gerador.codigo/template/java/Java.Controller.mustache';
        _this.arquivoTemplateService = 'I:/Doc/node/gerador.codigo/template/java/Java.Service.mustache';
        _this.arquivoTemplateRepository = 'I:/Doc/node/gerador.codigo/template/java/Java.Repository.mustache';
        _this.relacionamentos = new Array;
        return _this;
    }
    GeradorJava.prototype.gerarArquivos = function (tabela, result) {
     ...
     */
    GeradorJava.prototype.gerarAgregadosPrimeiroNivel = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    GeradorJava.prototype.gerarArquivosTabelaPrincipal = function () {
        return __awaiter(this, void 0, void 0, function () {
            var erro_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.sent();
                        // gera controller
                        return [4 /*yield*/, this.geraController()];
                    case 3:
                        // gera controller
                        _a.sent();
                        // gera service
                        return [4 /*yield*/, this.geraService()];
                    case 4:
                        // gera service
                        _a.sent();
                        return [4 /*yield*/, this.geraRepository()];
                    case 5:
                        _a.sent();
     ...
     */
    GeradorJava.prototype.pegarCampos = function (tabela) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    GeradorJava.prototype.gerarModel = function (tabela) {
        return __awaiter(this, void 0, void 0, function () {
            var modelJson, modelJson, modelTemplate, modelGerado, nomeArquivo;
            return __generator(this, function (_a) {
                if (tabela != this.tabela) {
                    modelJson = new java_model_1.JavaModel(tabela, this.dataPacket, null);
                }
                else {
                    modelJson = new java_model_1.JavaModel(tabela, this.dataPacket, this.relacionamentos);
                }
                ...
                return [2 /*return*/, _super.prototype.gravarArquivo.call(this, this.caminhoFontes + this.tabela + '/' + nomeArquivo + '.java', modelGerado)];
            });
        });
    };
    /**
     ...
     */
    GeradorJava.prototype.geraController = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelJson, modelTemplate, modelGerado, nomeArquivo;
            return __generator(this, function (_a) {
                modelJson = new java_controller_1.JavaController(this.tabela);
     ...
     */
    GeradorJava.prototype.geraService = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelJson, modelTemplate, modelGerado, nomeArquivo;
            return __generator(this, function (_a) {
                modelJson = new java_service_1.JavaService(this.tabela);
   ...
   * Gera o Service para a tabela principal
   */
    GeradorJava.prototype.geraRepository = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelJson, modelTemplate, modelGerado, nomeArquivo;
            return __generator(this, function (_a) {
                modelJson = new java_repository_1.JavaRepository(this.tabela);
                modelTemplate = fs.readFileSync(this.arquivoTemplateRepository).toString();
                modelGerado = Mustache.render(modelTemplate, modelJson);
                nomeArquivo = lodash.camelCase(this.tabela) + 'Repository';
                nomeArquivo = lodash.upperFirst(nomeArquivo);
                return [2 /*return*/, _super.prototype.gravarArquivo.call(this, this.caminhoFontes + this.tabela + '/' + nomeArquivo + '.java', modelGerado)];
            });
        });
