...
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_contato_detalhe_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_contato_persiste_page.dart';
...
class _PessoaContatoListaPageState extends State<PessoaContatoListaPage> {
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(
                  builder: (BuildContext context) => PessoaContatoPersistePage(
                      pessoa: widget.pessoa, pessoaContato: pessoaContato, title: 'Pessoa Contato - Inserido', operacao: 'I')))
              .then((_) {
            setState(() {
  ...
  detalharPessoaContato(Pessoa pessoa, PessoaContato pessoaContato, BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (BuildContext context) => PessoaContatoDetalhePage(pessoa: pessoa, pessoaContato: pessoaContato)))
        .then((_) {
      setState(() {
        getRows();
      });
