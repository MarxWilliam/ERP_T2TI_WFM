...
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_telefone_detalhe_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_telefone_persiste_page.dart';
...
class _PessoaTelefoneListaPageState extends State<PessoaTelefoneListaPage> {
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(
                  builder: (BuildContext context) => PessoaTelefonePersistePage(
                      pessoa: widget.pessoa, pessoaTelefone: pessoaTelefone, title: 'Pessoa Telefone - Inserido', operacao: 'I')))
              .then((_) {
            setState(() {
  ...
  detalharPessoaTelefone(Pessoa pessoa, PessoaTelefone pessoaTelefone, BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (BuildContext context) => PessoaTelefoneDetalhePage(pessoa: pessoa, pessoaTelefone: pessoaTelefone)))
        .then((_) {
      setState(() {
        getRows();
      });
