...
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_endereco_detalhe_page.dart';
...
class _PessoaEnderecoListaPageState extends State<PessoaEnderecoListaPage> {
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(
                  builder: (BuildContext context) => PessoaEnderecoPersistePage(
                      pessoa: widget.pessoa, pessoaEndereco: pessoaEndereco, title: 'Pessoa Endereco - Inserido', operacao: 'I')))
              .then((_) {
            setState(() {
  ...
  List<DataRow> getRows() {
    ...
    for (var pessoaEndereco in widget.pessoa.listaPessoaEndereco) {
      ...
      celulas = [
        ...
        DataCell(Text('${pessoaEndereco.municipioIbge.toString() ?? ''}'), onTap: () {
          detalharPessoaEndereco(widget.pessoa, pessoaEndereco, context);
        }),
  ...
  detalharPessoaEndereco(Pessoa pessoa, PessoaEndereco pessoaEndereco, BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (BuildContext context) => PessoaEnderecoDetalhePage(pessoa: pessoa, pessoaEndereco: pessoaEndereco)))
        .then((_) {
      setState(() {
        getRows();
      });
