...
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_endereco_persiste_page.dart';
...
class PessoaEnderecoDetalhePage extends StatefulWidget {
  ...
  const PessoaEnderecoDetalhePage({Key key, this.pessoa, this.pessoaEndereco}) : super(key: key);

  @override
  _PessoaEnderecoDetalhePageState createState() => _PessoaEnderecoDetalhePageState();
}
                ...
                onPressed: () {
                  return Navigator.of(context)
                    ...
                    builder: (BuildContext context) => PessoaEnderecoPersistePage(
                        pessoa: widget.pessoa, pessoaEndereco: widget.pessoaEndereco, title: 'Pessoa Endereco - Editando', operacao: 'A'),
                  ))
                      .then((_) {
                    setState(() {});
                  });
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('Detalhe de Pessoa Endereco', style: TextStyle(color: Colors.grey.shade700)),
                  ),
                  Card(
                    color: Colors.white,
                    elevation: 2.0,
                    child: Column(
                      children: <Widget>[
                        ...
                        ListTile(
                            leading: Icon(Icons.arrow_right, color: Colors.grey),
                            title: Text(widget.pessoaEndereco.municipioIbge.toString() ?? ''),
                        ...
                        ListTile(
                            leading: Icon(Icons.arrow_right, color: Colors.grey),
                            title: Text(widget.pessoaEndereco.correspondencia ?? ''),
                            subtitle: Text('Correspondencia')),
                      ],
                    ),
                  ),
                ],
