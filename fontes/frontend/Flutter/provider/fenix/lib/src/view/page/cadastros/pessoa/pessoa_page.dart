...
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_contato_lista_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_endereco_lista_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_fisica_persiste_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_juridica_persiste_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_persiste_page.dart';
import 'package:fenix/src/view/page/cadastros/pessoa/pessoa_telefone_lista_page.dart';
...
class PessoaPage extends StatefulWidget {
  ...
  PessoaPage({this.pessoa, this.title, this.operacao, Key key}) : super(key: key);
...
class PessoaPageState extends State<PessoaPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    ViewUtilLib.paginaMestreDetalheAlterada = false;
  }
  ...
  Widget build(BuildContext context) {
    return ViewUtilLib.getScaffoldAbaPage(widget.title, context, _abasController, getAbasAtivas(), getIndicator(), _estiloBotoesAba,
        salvarPessoa, alterarEstiloBotoes, avisarUsuarioAlteracoesNaPagina);
  }
  ...
  void atualizarAbas() {
    ...
    _todasAsAbas.add(Aba(
      ...
      pagina:
          PessoaFisicaPersistePage(formKey: _pessoaFisicaPersisteFormKey, scaffoldKey: _pessoaFisicaPersisteScaffoldKey, pessoa: widget.pessoa),
    ));
    _todasAsAbas.add(Aba(
      icon: Icons.business,
      ...
      pagina: PessoaJuridicaPersistePage(
          formKey: _pessoaJuridicaPersisteFormKey, scaffoldKey: _pessoaJuridicaPersisteScaffoldKey, pessoa: widget.pessoa),
    ));
    _todasAsAbas.add(Aba(icon: Icons.group, text: 'Contatos', visible: true, pagina: PessoaContatoListaPage(pessoa: widget.pessoa)));
    _todasAsAbas.add(Aba(icon: Icons.place, text: 'Endereços', visible: true, pagina: PessoaEnderecoListaPage(pessoa: widget.pessoa)));
    _todasAsAbas.add(Aba(icon: Icons.phone, text: 'Telefones', visible: true, pagina: PessoaTelefoneListaPage(pessoa: widget.pessoa)));
  }
  ...
  void salvarForms() {
    // valida e salva o form pessoa detalhe
  ...
  Future<bool> avisarUsuarioAlteracoesNaPagina() async {
    if (!ViewUtilLib.paginaMestreDetalheAlterada) return true;
