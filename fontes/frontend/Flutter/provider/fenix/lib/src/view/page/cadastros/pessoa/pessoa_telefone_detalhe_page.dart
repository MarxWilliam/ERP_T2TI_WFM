...
class PessoaTelefoneDetalhePage extends StatefulWidget {
  ...
  const PessoaTelefoneDetalhePage({Key key, this.pessoa, this.pessoaTelefone}) : super(key: key);

  @override
  _PessoaTelefoneDetalhePageState createState() => _PessoaTelefoneDetalhePageState();
}
                ...
                onPressed: () {
                  return Navigator.of(context)
                    ...
                    builder: (BuildContext context) => PessoaTelefonePersistePage(
                        pessoa: widget.pessoa, pessoaTelefone: widget.pessoaTelefone, title: 'Pessoa Telefone - Editando', operacao: 'A'),
                  ))
                      .then((_) {
                    setState(() {});
                  });
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('Detalhe de Pessoa Telefone', style: TextStyle(color: Colors.grey.shade700)),
                  ),
                  Card(
                    color: Colors.white,
                    elevation: 2.0,
