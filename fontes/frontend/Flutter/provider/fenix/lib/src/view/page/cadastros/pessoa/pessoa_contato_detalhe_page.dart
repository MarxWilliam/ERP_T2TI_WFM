...
class PessoaContatoDetalhePage extends StatefulWidget {
  ...
  const PessoaContatoDetalhePage({Key key, this.pessoa, this.pessoaContato}) : super(key: key);

  @override
  _PessoaContatoDetalhePageState createState() => _PessoaContatoDetalhePageState();
}
                ...
                onPressed: () {
                  return Navigator.of(context)
                    ...
                    builder: (BuildContext context) => PessoaContatoPersistePage(
                        pessoa: widget.pessoa, pessoaContato: widget.pessoaContato, title: 'Pessoa Contato - Editando', operacao: 'A'),
                  ))
                      .then((_) {
                    setState(() {});
                  });
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('Detalhe de Pessoa Contato', style: TextStyle(color: Colors.grey.shade700)),
                  ),
                  Card(
                    color: Colors.white,
                    elevation: 2.0,
